...
\begin{frame}{New Approach: Ranges for $\varepsilon$ and $k$}
    Let $k = [k_{min},k_{max}] = [3,5]$

    and $\varepsilon = [\varepsilon_{min},\varepsilon_{max}] = [2,3.5]$

    Now prune the table:

    \only<1>{\begin{tabular}{|c|c|c|c|c|c|}
        \hline
        \backslashbox{i}{k} & 1 & 2 & 3 & 4 & 5 \\
        \hline
        0 &  0 &  1.000000 &  1.000000 &  2.236068 &  4.123106\\
...
\end{tabular}}
    ...
    \only<2>{\begin{tabular}{|c|c|c|c|c|c|}
        \hline
        \backslashbox{i}{k} & 3 & 4 & 5 \\
        \hline
        0 & 1.000000 &  2.236068 &  4.123106\\
        1 & 1.414214 &  1.414214 &  4.000000\\
        2 & 1.414214 &  2.000000 &  3.162278\\
        3 & 4.000000 &  5.000000 &  5.000000\\
        4 & 3.162278 &  4.000000 &  4.123106\\
        5 & 2.000000 &  2.236068 &  3.162278\\
        6 & 5.000000 &  5.000000 &  6.403124\\
        \hline
\end{tabular}}
